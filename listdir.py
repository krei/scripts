...
class DirList:
    ...
    def __init__(self, initdir=None):
        self.top = Tk()
        self.label = Label(self.top, text='Список Директории ' + __version__)
        self.label.pack()
        ...
        self.clr = Button(self.bfm, text='очистка', command=self.clrdir,
            activeforeground='white', activebackground='blue')
        self.ls = Button(self.bfm, text='список директории',
            command=self.dols, activeforeground='white',
            activebackground='green')
        self.quit = Button(self.bfm, text='выход', command=self.top.quit,
